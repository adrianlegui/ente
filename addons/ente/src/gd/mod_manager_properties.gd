...
const MODS_FOLDER_PATH_PROPERTY: String = "ente/config/multi_mode/mods_folder_path"
...
const GAME_ID_PROPERTY_PATH: String = "ente/config/game_id"
...
const MAIN_MOD_PROPERTY_PATH: String = "ente/config/main_mod"
