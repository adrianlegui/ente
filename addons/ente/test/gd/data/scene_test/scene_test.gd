...
const __source = "res://addons/ente/src/gd/data/scene/scene.gd"
const SCENE = preload("res://addons/ente/src/gd/data/scene/scene.tscn")
const ENTITY_FOR_TEST = preload(
	"res://addons/ente/test/entity_for_test/entity_for_test.tscn"
)
const SCENE_PATH: String = "res://addons/ente/test/entity_for_test/entity_for_test.tscn"
